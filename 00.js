...
/* =====================================================
 ...
 (function () {
  ...
  function flyToCart(imgSrc, startEl) {
    const cartIcon = document.getElementById('headerBagBadge') || document.getElementById('footerBagBadge');
    if (!cartIcon) return;
    ...
    anim.onfinish = () => {
      ...
      // Shake the bag icon
      const bagIcon = document.querySelector('.app-header [aria-label="Your Bag"] i') || document.querySelector('.footer-nav [aria-label="Your Bag"] i');
      if (bagIcon) {
  ...
  window.showSection = function (sectionId) {
    ...
    document.querySelectorAll('.app-header [data-section], .footer-nav .nav-link').forEach(link => {
  ...
  window.toggleDarkMode = function () {
    ...
    if (toggle) {
      toggle.innerHTML = '<i class="bi bi-magic"></i>';
  ...
  document.querySelectorAll('.app-header [data-section], .footer-nav .nav-link').forEach(link => {
    link.addEventListener('click', function () {
      document.querySelectorAll('.app-header [data-section], .footer-nav .nav-link').forEach(l => l.classList.remove('active'));
